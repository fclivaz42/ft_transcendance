...
export class Ball {
    private mesh: Mesh;
    private ballEffects: BallEffects; // Instance pour gérer les effets de traînée

    constructor(scene: Scene, init: BallInit) {
        this.mesh = MeshBuilder.CreateSphere(
            "ball",
            {
                diameter: init.size[0], // Utilise la taille du backend
        ...
        this.ballEffects = new BallEffects(scene, this.mesh);
    ...
    update(update: BallUpdate) {
		...
		this.ballEffects.updateEffects();
