...
// 	saveButton.onclick = () => {
// 		const isDisplayNameValid = simpleupdateFieldAppearance(displayNameTextbox, displayNameErrorFeedback, validateDisplayName, false, true);
// 		const isEmailValid = simpleupdateFieldAppearance(emailTextbox, emailErrorFeedback, validateEmail, false, true);
// 		const isPasswordValid = simpleupdateFieldAppearance(passwordTextbox, passwordErrorFeedback, validatePassword, false, true);
// 		const isConfirmPasswordValid = simpleupdateFieldAppearance(
...
// 		emailTextbox._touched = true;
// 		simpleupdateFieldAppearance(emailTextbox, emailErrorFeedback, validateEmail, false, true);
// 	});
...
// 		passwordStrengthHelper.simpleupdate(strengthResult); // Met à jour l'apparence des critères
