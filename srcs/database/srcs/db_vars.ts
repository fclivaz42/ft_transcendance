...
//   Updated: 2025/07/08 09:05:49 by fclivaz          ###   LAUSANNE.ch       //
//                                                                            //
// ************************************************************************** //
...
const MatchesTable: db_table =
{
	...
	"Arguments": [
		"TEXT NOT NULL PRIMARY KEY",
		`TEXT DEFAULT '${default_users.Deleted.PlayerID}' REFERENCES ${PlayersTable.Name}(${PlayersTable.Fields[0]}) ON DELETE SET DEFAULT`,
		`TEXT DEFAULT '${default_users.Deleted.PlayerID}' REFERENCES ${PlayersTable.Name}(${PlayersTable.Fields[0]}) ON DELETE SET DEFAULT`,
		"INTEGER NOT NULL",
		"INTEGER NOT NULL",
		// "TEXT DEFAULT NULL",
