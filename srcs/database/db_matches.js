...
//   Updated: 2025/04/23 18:45:08 by fclivaz          ###   LAUSANNE.ch       //
//                                                                            //
// ************************************************************************** //
...
export async function get_matches(fastify) {
	fastify.get(`/${tables[1]}`, get_db(request, reply, tables[1], table_fields))
}
